...
var fileList = ["WikiNews", "Huffington", "CrooksAndLiars", "EmptyWheel", "Esquire", "FactCheck",
    ...
    "Basketball", "UCD", "UCD (short)", "NNDSS", "NNDSS (short)"]
var datasetsWithStates = ["Basketball", "UCD", "UCD (short)", "NNDSS", "NNDSS (short)"];
